...
def seleccionar_taller():
    ...
    return render_template('seleccionar_taller.html', talleres=talleres)
...
def historial_asistencia(taller_id):
    ...
    return render_template('historial_asistencia.html', taller=taller, clases=clases, estudiantes=estudiantes, asistencia_dict=asistencia_dict)
